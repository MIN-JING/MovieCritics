...
class DetailFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Logger.i("Detail Fragment onCreate()")
    }
...
//    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        Logger.i("Detail Fragment onViewCreated()")
        super.onViewCreated(view, savedInstanceState)
    }

    override fun onStart() {
        Logger.i("Detail Fragment onStart()")
        super.onStart()
    }

    override fun onResume() {
        Logger.i("Detail Fragment onResume()")
        super.onResume()
    }

    override fun onPause() {
        Logger.i("Detail Fragment onPause()")
        super.onPause()
    }

    override fun onStop() {
        Logger.i("Detail Fragment onStop()")
        super.onStop()
    }

    override fun onSaveInstanceState(outState: Bundle) {
        Logger.i("Detail Fragment onSaveInstanceState()")
        super.onSaveInstanceState(outState)
    }

    override fun onDestroyView() {
        Logger.i("Detail Fragment onDestroyView()")
        super.onDestroyView()
    }

    override fun onDestroy() {
        Logger.i("Detail Fragment onDestroy()")
        super.onDestroy()
    }

    override fun onAttach(context: Context) {
        Logger.i("Detail Fragment onAttach()")
        super.onAttach(context)
    }

    override fun onDetach() {
        Logger.i("Detail Fragment onDetach()")
        super.onDetach()
    }
